        ...
        <AnimatePresence mode="wait">
          ...
          {step === 'ready' && (
            <motion.div key="ready" variants={fadeInUp} initial="initial" animate="animate" exit="exit" className="text-center py-8">
              ...
              <p className="text-xs mb-4" style={{ color: 'rgba(255,255,255,0.4)' }}>British Pounds (GBP)</p>
              <div className="w-full p-3 rounded-xl mb-5 text-left"
                style={{ background: 'rgba(234,179,8,0.1)', border: '1px solid rgba(234,179,8,0.3)' }}>
                <p className="text-xs font-semibold" style={{ color: 'rgba(253,224,71,0.9)' }}>⚠️ NOTE: When the payment page opens, enter exactly <span className="font-bold">£{assignment.paymentAmount?.toFixed(2)}</span> as the amount. Do not change this figure. Entering the wrong amount will delay your order.</p>
              </div>
          ...
          {step === 'success' && (
            <motion.div key="success" variants={fadeInUp} initial="initial" animate="animate" exit="exit" className="text-center py-8">
              ...
              <p className="mb-4" style={{ color: 'rgba(255,255,255,0.7)' }}>£{assignment.paymentAmount?.toFixed(2)} received. Your assignment is now in progress.</p>
